...
namespace UwpGame
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public static float scaleWidth, scaleHeight, pointX, pointY, bulletX, bulletY, shootplayerX, shootplayerY, currPosPlayerX, currPosPlayerY;
        ...
        {
            StartScreen = await CanvasBitmap.LoadAsync(sender, new Uri("ms-appx:///Assets/Images/level.png"));
            Level1 = await CanvasBitmap.LoadAsync(sender, new Uri("ms-appx:///Assets/Images/ingame.png"));
            Level2 = await CanvasBitmap.LoadAsync(sender, new Uri("ms-appx:///Assets/Images/bullet.png"));
            Bullet = await CanvasBitmap.LoadAsync(sender, new Uri("ms-appx:///Assets/Images/bullet.png"));
            Player = await CanvasBitmap.LoadAsync(sender, new Uri("ms-appx:///Assets/Images/JeroenSprite.png"));
        }
