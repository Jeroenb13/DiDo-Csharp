...
namespace DiDo.Levels
{
    public class Levels
    {
        ...
        public static String[,] levelThree =  { //20x25
            ...
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "b", "b", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "J"},
            {"L", "b", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "J"},
            {"L", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "J"},
            {"L", "b", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "J"},
            {"T", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "K", "S"},
        };
        public static String[,] levelFour = { // 26 x 26
            {"Q","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","R"},
            {"L","b","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","J"},
            {"L","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","9","R","R","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","V","V","V","@","f","f","f","f","f","!","V","@","b","b","f","b","f","f","f","f","f","f","f","f","J"},
            {"L","H","H","H","X","f","f","f","f","f","T","H","X","f","f","f","b","f","f","f","f","f","f","f","f","J"},
            {"L","R","R","R","8","f","f","f","f","f","9","R","8","b","b","b","b","f","f","f","f","f","f","f","f","J"},
            {"L","f","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","b","f","f","f","f","f","b","f","f","f","f","f","f","b","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","b","f","f","f","f","f","!","V","V","@","f","f","f","f","f","f","J"},
            {"L","f","b","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","X","f","f","f","f","f","f","J"},
            {"L","f","b","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","X","f","f","f","f","f","f","J"},
            {"L","b","b","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","X","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","X","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","T","H","H","X","f","f","f","!","V","V","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","9","R","R","8","f","f","f","9","R","R","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","V","V","@","f","f","f","f","f","f","f","f","f","f","f","b","f","f","f","f","f","f","f","f","f","J"},
            {"L","H","H","X","f","f","f","f","f","f","!","V","V","V","V","@","f","f","f","f","f","f","f","f","f","J"},
            {"L","H","H","X","f","f","f","f","f","f","T","H","H","H","H","X","f","f","f","f","f","f","f","f","f","J"},
            {"T","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","K","S"}
        };
        ...
        { // 36x25
            {"Q","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","I","R"},
            {"L","f","f","f","f","f","f","f","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","b","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","b","b","b","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","f","b","b","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","b","b","b","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","9","R","R","R","R","R","R","R","R","R","R","R","R","R","8","f","f","f","f","f","f","f","b","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","b","f","f","f","f","f","b","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","!","V","V","V","@","f","f","f","f","f","!","V","V","V","@","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","b","T","H","H","H","Y","V","V","V","V","V","W","H","H","H","X","f","f","f","f","f","b","b","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","b","b","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","b","b","b","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","b","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","b","b","b","b","f","f","f","J"},
            {"L","f","f","f","f","f","f","b","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","b","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","T","H","H","H","H","H","H","H","H","H","H","H","H","H","X","f","f","f","b","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","9","R","R","R","R","R","R","R","R","R","R","R","R","R","8","f","f","b","b","b","f","f","f","f","b","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","b","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","b","b","b","f","f","f","b","b","f","f","J"},
            {"L","f","b","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","b","b","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
            {"L","f","f","f","f","f","f","f","f","f","f","f","b","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","f","J"},
