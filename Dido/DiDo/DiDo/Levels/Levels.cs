...
namespace DiDo.Levels
{
    public static class Levels
    {
        ...
        {
            { "a", new Tile("bridge", new Uri("ms-appx:///Assets/Tiles/bridge/0.png"), true) },
            { "b", new Tile("crate", new Uri("ms-appx:///Assets/Tiles/crate.png")) },
            { "c", new Tile("disco", new Uri("ms-appx:///Assets/Tiles/spr_disco.png"), true) },
            { "d", new Tile("door", new Uri("ms-appx:///Assets/Tiles/door/0.png")) },
            { "e", new Tile("fence", new Uri("ms-appx:///Assets/Tiles/fence.png")) },
            { "f", new Tile("floor", new Uri("ms-appx:///Assets/Tiles/floors/floor.png"), true) },
            { "g", new Tile("floor_cracked_1", new Uri("ms-appx:///Assets/Tiles/floors/crack-1.png"), true) },
            { "h", new Tile("floor_cracked_2", new Uri("ms-appx:///Assets/Tiles/floors/crack-2.png"), true) },
            { "i", new Tile("floor_cracked_3", new Uri("ms-appx:///Assets/Tiles/floors/crack-3.png"), true) },
            { "j", new Tile("floor_cracked_4", new Uri("ms-appx:///Assets/Tiles/floors/crack-4.png"), true) },
            { "k", new Tile("floor_cracked_5", new Uri("ms-appx:///Assets/Tiles/floors/crack-5.png"), true) },
            { "l", new Tile("floor_cracked_6", new Uri("ms-appx:///Assets/Tiles/floors/crack-6.png"), true) },
            { "m", new Tile("gas", new Uri("ms-appx:///Assets/Tiles/gas.png")) },
            { "n", new Tile("grass" , new Uri("ms-appx:///Assets/Tiles/grass_1.png"), true)},
            { "o", new Tile("grass_flower_1" , new Uri("ms-appx:///Assets/Tiles/floors/flowers/flower_1.png"), true)},
            { "p", new Tile("grass_flower_2", new Uri("ms-appx:///Assets/Tiles/flowers/flower_2.png"), true) },
            { "q", new Tile("grass_flower_3", new Uri("ms-appx:///Assets/Tiles/flowers/flower_3.png"), true) },
            { "r", new Tile("grass_flower_4", new Uri("ms-appx:///Assets/Tiles/flowers/flower_4.png"), true) },
            { "s", new Tile("grass_flower_5", new Uri("ms-appx:///Assets/Tiles/flowers/flower_5.png"), true) },
            { "t", new Tile("path_0_straight", new Uri("ms-appx:///Assets/Tiles/paths/straight/0.png"), true) },
            { "u", new Tile("path_0_turn", new Uri("ms-appx:///Assets/Tiles/paths/turn/0.png"), true) },
            { "v", new Tile("path_0_cross" , new Uri("ms-appx:///Assets/Tiles/paths/cross/0.png"), true)},
            { "w", new Tile("path_0_t", new Uri("ms-appx:///Assets/Tiles/paths/t/0.png"), true) },
            { "x", new Tile("path_90_straight" , new Uri("ms-appx:///Assets/Tiles/paths/straight/90.png"), true, 90)},
            { "y", new Tile("path_90_turn", new Uri("ms-appx:///Assets/Tiles/paths/turn/90.png"), true, 90) },
            { "z", new Tile("path_90_cross" , new Uri("ms-appx:///Assets/Tiles/paths/cross/90.png"), true, 90)},
            { "A", new Tile("path_90_t", new Uri("ms-appx:///Assets/Tiles/paths/t/90.png"), true, 90) },
            { "B", new Tile("path_180_straight" , new Uri("ms-appx:///Assets/Tiles/paths/straight/180.png"), true, 180)},
            { "C", new Tile("path_180_turn" , new Uri("ms-appx:///Assets/Tiles/paths/turn/180.png"), true, 180)},
            { "D", new Tile("path_180_cross", new Uri("ms-appx:///Assets/Tiles/paths/cross/180.png"), true, 180) },
            { "E", new Tile("path_180_t", new Uri("ms-appx:///Assets/Tiles/paths/t/180.png"), true, 180) },
            { "F", new Tile("path_270_straight" , new Uri("ms-appx:///Assets/Tiles/paths/straight/270.png"), true, 270)},
            { "G", new Tile("path_270_turn" , new Uri("ms-appx:///Assets/Tiles/paths/turn/270.png"), true, 270)},
            { "H", new Tile("path_270_cross", new Uri("ms-appx:///Assets/Tiles/paths/cross/270.png"), true, 270) },
            { "I", new Tile("path_270_t", new Uri("ms-appx:///Assets/Tiles/paths/t/270.png"), true, 270) },
            ...
            { "M", new Tile("torch_0", new Uri("ms-appx:///Assets/Tiles/walls/torch/0.png")) },
            { "N", new Tile("torch_90", new Uri("ms-appx:///Assets/Tiles/walls/torch/90.png")) },
            { "O", new Tile("torch_180", new Uri("ms-appx:///Assets/Tiles/walls/torch/180.png")) },
            { "P", new Tile("torch_270", new Uri("ms-appx:///Assets/Tiles/walls/torch/270.png")) },
            { "Q", new Tile("tree", new Uri("ms-appx:///Assets/Tiles/tree.png")) },
            { "R", new Tile("wall_0_straight", new Uri("ms-appx:///Assets/Tiles/walls/straight/0.png")) },
            { "S", new Tile("wall_0_turn", new Uri("ms-appx:///Assets/Tiles/walls/turn/0.png")) },
            { "T", new Tile("wall_90_straight", new Uri("ms-appx:///Assets/Tiles/walls/straight/90.png"), false, 90) },
            { "U", new Tile("wall_90_turn", new Uri("ms-appx:///Assets/Tiles/walls/turn/90.png"), false, 90) },
            { "V", new Tile("wall_180_straight", new Uri("ms-appx:///Assets/Tiles/walls/straight/180.png"), false, 180) },
            { "W", new Tile("wall_180_turn", new Uri("ms-appx:///Assets/Tiles/walls/turn/180.png"), false, 180) },
            { "X", new Tile("wall_270_straight", new Uri("ms-appx:///Assets/Tiles/walls/straight/270.png"), false, 270) },
            { "Y", new Tile("wall_270_turn", new Uri("ms-appx:///Assets/Tiles/walls/turn/270.png"), false, 270) },
