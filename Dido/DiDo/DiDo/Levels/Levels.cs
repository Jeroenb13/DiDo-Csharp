...
namespace DiDo.Levels
{
    public class Levels
    {
        Dictionary<String, Tile> tiles = new Dictionary<String, Tile>()
        {
            ...
            { "r", new Tile("grass_flower_4", new Uri("ms-appx:///Assets/Tiles/flower-4.png"), true) },
            { "s", new Tile("grass_flower_5", new Uri("ms-appx:///Assets/Tiles/flower-5.png"), true) },
            ...
            { "x", new Tile("path_90_straight" , new Uri("ms-appx:///Assets/Tiles/path_1.png"), true)},
            { "y", new Tile( "path_90_turn", new Uri("ms-appx:///Assets/Tiles/path_2.png"), true) },
            { "z", new Tile("path_90_cross" , new Uri("ms-appx:///Assets/Tiles/path_3.png"), true)},
            { "A", new Tile("path_90_t", new Uri("ms-appx:///Assets/Tiles/path_4.png"), true) },
            { "B", new Tile("path_180_straight" , new Uri("ms-appx:///Assets/Tiles/path_1.png"), true)},
            { "C", new Tile("path_180_turn" , new Uri("ms-appx:///Assets/Tiles/path_2.png"), true)},
            { "D", new Tile("path_180_cross", new Uri("ms-appx:///Assets/Tiles/path_3.png"), true) },
            { "E", new Tile("path_180_t", new Uri("ms-appx:///Assets/Tiles/path_4.png"), true) },
            { "F", new Tile("path_270_straight" , new Uri("ms-appx:///Assets/Tiles/path_1.png"), true)},
            { "G", new Tile("path_270_turn" , new Uri("ms-appx:///Assets/Tiles/path_2.png"), true)},
            { "H", new Tile("path_270_cross", new Uri("ms-appx:///Assets/Tiles/path_3.png"), true) },
            { "I", new Tile("path_270_t", new Uri("ms-appx:///Assets/Tiles/path_4.png"), true) },
